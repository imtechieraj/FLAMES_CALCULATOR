...
let flames_num = [1, 2, 3, 4, 5, 6];
const flamesCalc = (count) => {
...
const match = (str1, str2) => {
  ...
  return flamesCalc(str1_arr.length + str2_arr.length);
};

console.log(match("rajkumar", "jeyasri"));
